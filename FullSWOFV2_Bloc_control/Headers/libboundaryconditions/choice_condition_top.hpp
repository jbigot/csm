...
#define Class_choice_condition_top

/*!
 * \file choice_condition_top.hpp
 * \brief Allows to choose and calculate right boundary condition
 * \author Olivier Delestre
 */

/*! \class choice_condition_top
...
private :
     ...
     * \brief Constructor
     */
    choice_condition_top(int);

    static choice_condition_top * singleton;
    boundary_condition * C;

public :

    static choice_condition_top * getSingleton(int choice);
