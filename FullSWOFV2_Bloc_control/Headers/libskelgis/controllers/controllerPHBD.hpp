...
template<class T, int R,bool line=true> struct ControllerPHBD
{
private :
...
template<class T> struct ControllerPHBD<T,0,true>
{
private :
...
template<class T,int R> struct ControllerPHBD<T,R,false>
{
private :
