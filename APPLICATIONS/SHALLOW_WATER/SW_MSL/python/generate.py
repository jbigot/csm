...
tempProcF = open("template_process_ompfor.xml",'r')
tempCommF = open("template_comm.xml",'r')

tempProc = Template(tempProcF.read())

ladFile = open("/ccc/scratch/cont003/gen7470/coullohe/ladfiles/base_"+str(size_x)+"_"+str(iteration)+"_"+str(nb_proc)+".lad", "w")
ladTxt=""
