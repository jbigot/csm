  ...
  */
  ...
  protected:
      ...
      else
	{
      ...
      //this->print(st1.str());
#endif
      //std::cout<<this->mpi_rank<<" - cols="<<this->cols<<" rows="<<this->rows<<std::endl;
    ...
    */
    //-------------------------------------------------------------------------------
    /*T **/void getRightBorderToSend()
    //-------------------------------------------------------------------------------
    {
      //T * result = /*(T*)malloc(this->loc_head.height*border*sizeof(T));*/new T[this->loc_head.height*border];
      for(unsigned int i=0;i<this->loc_head.height;i++)
	{
  ...
  public:
    ...
    */
	  ...
	  if(this->row!=0)
	    {
	      ...
	      getUpBorderToSend();
	      //chrono2.stop();
	      //std::cout<<this->mpi_rank<<" - Time up 1 : "<<chrono2.dureeCalcule()<<std::endl;
	      //std::cout<<"alloc = "<<this->loc_head.width*border<<std::endl;
	      //T * toGet = new T[this->loc_head.width*border];
	      //b=rdtsc();
	      //std::cout<<"toSend = "<<b-a<<std::endl;
	      //a=rdtsc();
	      //Chronometer chrono3;
              //chrono3.start();
	      Communications<T>::Exchanges(toSendUp,toGetUp,getUp,this->loc_head.width*border,mpi_ranks[1]);//,this->communicator);
	      //chrono3.stop();
	      //std::cout<<this->mpi_rank<<" - Time up 2 : "<<chrono3.dureeCalcule()<<std::endl;
	      //b=rdtsc();
	      //std::cout<<"end communications = "<<b-a<<std::endl;
	      //Chronometer chrono4;
              //chrono4.start();
	      setUpBorder(toGetUp);
	      //chrono4.stop();
	      //std::cout<<this->mpi_rank<<" - Time up 3 : "<<chrono4.dureeCalcule()<<std::endl;
	      //delete [] toSend;
	      //delete [] toGet;
	      //chrono.stop();
	      //std::cout<<this->mpi_rank<<" - Time up : "<<chrono.dureeCalcule()<<std::endl;
	    }
	  if(this->row!=(this->rows-1))
	    {
	      //Chronometer chrono;
	      ...
	      getDownBorderToSend();
	      //chrono2.stop();
	      //std::cout<<this->mpi_rank<<" - Time down 1 : "<<chrono2.dureeCalcule()<<std::endl;
	      //std::cout<<"alloc = "<<this->loc_head.width*border<<std::endl;
	      //T * toGet = new T[this->loc_head.width*border];
	      //b=rdtsc();
	      //std::cout<<"toSend = "<<b-a<<std::endl;
	      ...
	      //chrono3.stop();
	      //std::cout<<this->mpi_rank<<" - Time down 2 : "<<chrono3.dureeCalcule()<<std::endl;
	      //b=rdtsc();
	      //std::cout<<"end communications = "<<b-a<<std::endl;
	      //Chronometer chrono4;
              //chrono4.start();
	      ...
	      //chrono4.stop();
	      //std::cout<<this->mpi_rank<<" - Time down 3 : "<<chrono4.dureeCalcule()<<std::endl;
	      //delete [] toSend;
	      //delete [] toGet;
	      //chrono.stop();
	      //std::cout<<this->mpi_rank<<" - Time down : "<<chrono.dureeCalcule()<<std::endl;
	    }
	}
	  ...
	  if(this->col!=(this->cols-1))
	    {
	      ...
	      //chrono2.stop();
	      //std::cout<<this->mpi_rank<<" - Time right 1 : "<<chrono2.dureeCalcule()<<std::endl;
	      //std::cout<<"alloc = "<<this->loc_head.height*border<<std::endl;
	      ...
	      //chrono3.stop();
	      //std::cout<<this->mpi_rank<<" - Time right 2 : "<<chrono3.dureeCalcule()<<std::endl;
	      //b=rdtsc();
	      //std::cout<<"end communications = "<<b-a<<std::endl;
	      //Chronometer chrono4;
              //chrono4.start();
	      ...
	      //chrono4.stop();
	      //std::cout<<this->mpi_rank<<" - Time right 3 : "<<chrono4.dureeCalcule()<<std::endl;
	      //delete [] toSend;
	      //delete [] toGet;
	      //chrono.stop();
	      //std::cout<<this->mpi_rank<<" - Time right : "<<chrono.dureeCalcule()<<std::endl;
	    }
	  if(this->col!=0)
	    {
	      //Chronometer chrono;
	      ...
	      getLeftBorderToSend();
	      //chrono2.stop();
	      //std::cout<<this->mpi_rank<<" - Time left 1 : "<<chrono2.dureeCalcule()<<std::endl;
	      //std::cout<<"alloc = "<<this->loc_head.height*border<<std::endl;
	      //T * toGet = new T[this->loc_head.height*border];
	      //b=rdtsc();
	      //std::cout<<"toSend = "<<b-a<<std::endl;
	      ...
	      //chrono3.stop();
	      //std::cout<<this->mpi_rank<<" - Time left 2 : "<<chrono3.dureeCalcule()<<std::endl;
	      //b=rdtsc();
	      //std::cout<<"end communications = "<<b-a<<std::endl;
	      //Chronometer chrono4;
              //chrono4.start();
	      ...
	      //chrono4.stop();
	      //std::cout<<this->mpi_rank<<" - Time left 3 : "<<chrono4.dureeCalcule()<<std::endl;
	      //delete [] toSend;
	      //delete [] toGet;
	      //chrono.stop();
	      //std::cout<<this->mpi_rank<<" - Time left : "<<chrono.dureeCalcule()<<std::endl;
	    }
	}
      else if(this->col%2==1)
	{
      ...
      //chrono.stop();
      //std::cout<<this->mpi_rank<<" - Time getBorders : "<<chrono.dureeCalcule()<<std::endl;
    }
    //-------------------------------------------------------------------------------
    inline HEADER getGlobalHeader(){return this->head;}
    //-------------------------------------------------------------------------------
