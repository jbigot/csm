#!/bin/bash
#MSUB -r weakMSL_51200_200_4096         #job name
#MSUB -n 4096                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/800/weakMSL_51200_200_4096_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/800/weakMSL_51200_200_4096_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 51200_51200_200_4096
