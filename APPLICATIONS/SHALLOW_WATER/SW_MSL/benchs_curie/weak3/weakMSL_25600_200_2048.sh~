#!/bin/bash
#MSUB -r weakMSL_12800_500_2048         #job name
#MSUB -n 2048                     #number of nodes
#MSUB -T 500                  #time ou
#MSUB -o $WORKDIR/results/weak_scaling/400/weakMSL_12800_500_2048_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/weakMSL_12800_500_2048_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 12800_25600_500_2048
