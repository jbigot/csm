#!/bin/bash
#MSUB -r weakMSL_1600_500_16         #job name
#MSUB -n 16                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/weakMSL_1600_500_16_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/weakMSL_1600_500_16_%I.e    #error file
#MSUB -q standard
...
#ccc_mprun -n ${BRIDGE_MSUB_NPROC} valgrind --leak-check=full --log-file=$WORKDIR/results/weak_scaling/400/leaks.out.%p /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 1600_1600_5_16
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 1600_1600_500_16
