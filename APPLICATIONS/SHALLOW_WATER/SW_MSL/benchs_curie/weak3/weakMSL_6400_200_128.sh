#!/bin/bash
#MSUB -r weakMSL_6400_200_128         #job name
#MSUB -n 128                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/800/weakMSL_6400_200_128_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/800/weakMSL_6400_200_128_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 6400_12800_200_128
