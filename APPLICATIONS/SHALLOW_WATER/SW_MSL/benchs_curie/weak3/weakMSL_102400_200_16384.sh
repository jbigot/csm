#!/bin/bash
#MSUB -r weakMSL_102400_200_16384         #job name
#MSUB -n 16384                     #number of nodes
#MSUB -T 1500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/800/weakMSL_102400_200_16384_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/800/weakMSL_102400_200_16384_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 102400_102400_200_16384
