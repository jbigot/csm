#!/bin/bash
#MSUB -r task2MSL_1k_500_16         #job name
#MSUB -n 16                     #number of nodes
#MSUB -c 2
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/1K_500/task2/task2MSL_1k_500_16_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/1K_500/task2/task2MSL_1k_500_16_%I.e    #error file
#MSUB -q standard
