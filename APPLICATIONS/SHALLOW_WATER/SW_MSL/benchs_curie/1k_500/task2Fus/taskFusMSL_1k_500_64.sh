#!/bin/bash
#MSUB -r taskFus2MSL_1k_500_32         #job name
#MSUB -n 32                     #number of nodes
#MSUB -c 2
#MSUB -T 500                  #time out
#MSUB -o $SCRATCHDIR/benchs_curie/MSL/task/taskFus2MSL_1k_500_32_%I.o    #output file
#MSUB -e $SCRATCHDIR/benchs_curie/MSL/task/taskFus2MSL_1k_500_32_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- /ccc/scratch/cont003/gen7470/coullohe/ladfiles/task/taskFus_1000_500_32.lad
