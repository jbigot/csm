#!/bin/bash
#MSUB -r task4MSL_1k_500_2048         #job name
#MSUB -n 2048                     #number of nodes
#MSUB -c 4
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/1K_500/task4/task4MSL_1k_500_2048_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/1K_500/task4/task4MSL_1k_500_2048_%I.e    #error file
#MSUB -q standard
