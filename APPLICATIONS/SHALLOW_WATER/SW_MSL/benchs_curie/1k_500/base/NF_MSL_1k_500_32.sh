#!/bin/bash
#MSUB -r base_MSL_1k_500_32         #job name
#MSUB -n 32                     #number of nodes
#MSUB -T 800                  #time out
#MSUB -o $WORKDIR/results/task_scaling/1K_500/base/base_MSL_1k_500_32_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling/1K_500/base/base_MSL_1k_500_32_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- $SCRATCHDIR/ladfiles/base_1000_500_32.lad
