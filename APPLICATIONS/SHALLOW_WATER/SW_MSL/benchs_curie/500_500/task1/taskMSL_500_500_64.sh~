#!/bin/bash
#MSUB -r task1MSL_1k_500_64         #job name
#MSUB -n 64                     #number of nodes
#MSUB -c 1
#MSUB -T 500                  #time out
#MSUB -o $SCRATCHDIR/benchs_curie/MSL/task/task1MSL_1k_500_64_%I.o    #output file
#MSUB -e $SCRATCHDIR/benchs_curie/MSL/task/task1MSL_1k_500_64_%I.e    #error file
#MSUB -q standard
