#!/bin/bash
#MSUB -r task1MSL_500_500_2048         #job name
#MSUB -n 2048                     #number of nodes
#MSUB -c 1
#MSUB -T 500                  #time out
#MSUB -o $SCRATCHDIR/benchs_curie/MSL/task/task1MSL_500_500_2048_%I.o    #output file
#MSUB -e $SCRATCHDIR/benchs_curie/MSL/task/task1MSL_500_500_2048_%I.e    #error file
#MSUB -q standard
