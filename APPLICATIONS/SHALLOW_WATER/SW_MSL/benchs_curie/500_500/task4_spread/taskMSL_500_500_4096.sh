#!/bin/bash
#MSUB -r task4MSL_500_500_1024         #job name
#MSUB -n 1024                     #number of nodes
#MSUB -c 4
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_500/task4/task4MSL_500_500_1024_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_500/task4/task4MSL_500_500_1024_%I.e    #error file
#MSUB -q standard
