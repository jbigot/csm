#!/bin/bash
#MSUB -r taskFus2MSL_500_500_64         #job name
#MSUB -n 64                     #number of nodes
#MSUB -c 2
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_500/task2Fus/taskFus2MSL_500_500_64_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_500/task2Fus/taskFus2MSL_500_500_64_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- /ccc/scratch/cont003/gen7470/coullohe/ladfiles/task/taskFus_500_500_64.lad
