#!/bin/bash
#MSUB -r fus_MSL_500_200_2048         #job name
#MSUB -n 2048                     #number of nodes
#MSUB -T 400                  #time out
#MSUB -o $WORKDIR/results/task_scaling/500_200/fus/fus_MSL_500_200_2048_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling/500_200/fus/fus_MSL_500_200_2048_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- $SCRATCHDIR/ladfiles/fus_500_200_2048.lad
