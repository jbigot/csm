#!/bin/bash
#MSUB -r task4MSL_500_200_64         #job name
#MSUB -n 64                     #number of nodes
#MSUB -c 4
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_200/task4/task4MSL_500_200_64_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_200/task4/task4MSL_500_200_64_%I.e    #error file
#MSUB -q standard
