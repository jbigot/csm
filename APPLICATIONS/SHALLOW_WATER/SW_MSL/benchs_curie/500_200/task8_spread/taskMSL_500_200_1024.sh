#!/bin/bash
#MSUB -r task8MSL_500_200_128         #job name
#MSUB -n 128                     #number of nodes
#MSUB -c 8
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_200/task8/task8MSL_500_200_128_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_200/task8/task8MSL_500_200_128_%I.e    #error file
#MSUB -q standard
