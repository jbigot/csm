#!/bin/bash
#MSUB -r task8MSL_500_200_32         #job name
#MSUB -n 32                     #number of nodes
#MSUB -c 8
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_200/task8/task8MSL_500_200_32_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_200/task8/task8MSL_500_200_32_%I.e    #error file
#MSUB -q standard
