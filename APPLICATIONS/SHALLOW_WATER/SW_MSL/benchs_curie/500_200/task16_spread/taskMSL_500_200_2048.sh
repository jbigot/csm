#!/bin/bash
#MSUB -r task16MSL_500_200_128         #job name
#MSUB -n 128                     #number of nodes
#MSUB -c 16
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_200/task16/task16MSL_500_200_128_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_200/task16/task16MSL_500_200_128_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- /ccc/scratch/cont003/gen7470/coullohe/ladfiles/task/task_500_200_128.lad
