#!/bin/bash
#MSUB -r base_MSL_500_1_256         #job name
#MSUB -n 256                     #number of nodes
#MSUB -T 300                  #time out
#MSUB -o $WORKDIR/results/task_scaling/500_1/base/base_MSL_500_1_256_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling/500_1/base/base_MSL_500_1_256_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- $SCRATCHDIR/ladfiles/base_500_1_256.lad
