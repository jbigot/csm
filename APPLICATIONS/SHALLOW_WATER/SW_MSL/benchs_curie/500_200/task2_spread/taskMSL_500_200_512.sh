#!/bin/bash
#MSUB -r task2MSL_500_200_256         #job name
#MSUB -n 256                     #number of nodes
#MSUB -c 2
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/task_scaling_spread/500_200/task2/task2MSL_500_200_256_%I.o    #output file
#MSUB -e $WORKDIR/results/task_scaling_spread/500_200/task2/task2MSL_500_200_256_%I.e    #error file
#MSUB -q standard
