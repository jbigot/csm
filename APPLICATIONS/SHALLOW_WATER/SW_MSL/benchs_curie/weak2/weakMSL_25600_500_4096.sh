#!/bin/bash
#MSUB -r weakMSL_25600_500_4096         #job name
#MSUB -n 4096                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/weakMSL_25600_500_4096_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/weakMSL_25600_500_4096_%I.e    #error file
#MSUB -q standard
...
#ccc_mprun -n ${BRIDGE_MSUB_NPROC} valgrind --leak-check=full --log-file=$WORKDIR/results/weak_scaling/400/leaks.out.%p /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 25600_25600_1_4096
#ccc_mprun -n ${BRIDGE_MSUB_NPROC} valgrind --tool=callgrind --cache-sim=yes --branch-sim=yes --dump-instr=yes --collect-jumps=yes --callgrind-out-file=$WORKDIR/results/weak_scaling/400/cg.out.%p /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 25600_25600_1_4096
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 25600_25600_500_4096
#ddt -start -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 25600_25600_1_4096
#scalasca -analyze -t ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 25600_25600_1_4096