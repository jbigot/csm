#!/bin/bash
#MSUB -r weakMSL_25600_500_8192         #job name
#MSUB -n 8192                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/weakMSL_25600_500_8192_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/weakMSL_25600_500_8192_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 25600_51200_500_8192
