#!/bin/bash
#MSUB -r weakMSL_400_500_2         #job name
#MSUB -n 2                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/weakMSL_400_500_2_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/weakMSL_400_500_2_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 400_800_500_2
