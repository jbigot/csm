#!/bin/bash
#MSUB -r weakMSL_1600_500_32         #job name
#MSUB -n 32                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/weakMSL_1600_500_32_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/weakMSL_1600_500_32_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader  -- 1600_3200_500_32
