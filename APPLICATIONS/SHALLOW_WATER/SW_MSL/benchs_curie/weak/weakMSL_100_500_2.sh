#!/bin/bash
#MSUB -r weakMSL_100_500_2         #job name
#MSUB -n 2                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $SCRATCHDIR/benchs_curie/MSL/weak/weakMSL_100_500_2_%I.o    #output file
#MSUB -e $SCRATCHDIR/benchs_curie/MSL/weak/weakMSL_100_500_2_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/bin/llcmcpp_loader  -- /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2C/INSTALL/lib/lad/l2c/cppmpiloader.lad -- $SCRATCHDIR/ladfiles/weak/FusSK_100_500_2.lad
