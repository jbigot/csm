#!/bin/bash
#MSUB -r NF_MSL_10k_1k_4096         #job name
#MSUB -n 4096                     #number of nodes
#MSUB -T 100                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/NF_MSL_10k_1k_4096_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/NF_MSL_10k_1k_4096_%I.e    #error file
#MSUB -q standard
...
ccc_mprun -n ${BRIDGE_MSUB_NPROC} /ccc/cont003/home/gen7470/coullohe/LIBRARIES/L2CLIGHT/INSTALL/bin/llcmcpp_loader -- 10000_10000_1000_4096
