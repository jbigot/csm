...
class DataSK0:virtual public Go,virtual public Datah
{

public:
  DMatrix_impl<double,0,false> * dmatrix;
  ...
  /*!  */
  //-------------------------------------------------------------------------------
  inline void setMiddle(double val){}
  //-------------------------------------------------------------------------------
  //! Return the pointer on the data
  /*!  */
  //-------------------------------------------------------------------------------
  inline void getData(double * & data){data=dmatrix->getData();}
  inline void getDMatrix(skelgis::DMatrix_impl<double,2,false> * & dm){dm = NULL;}
