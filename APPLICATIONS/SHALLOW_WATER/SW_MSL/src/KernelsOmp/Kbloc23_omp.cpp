...
#pragma omp parallel for shared(cu,cv,cq2,ch2g,ch2d,ch2l,ch2r,cdelzc2,cf3,cg3,chs,cqs2) private(yy,xx,xxq,xx1,xx2) firstprivate(yyq,yy1,yy2) schedule (static, CHUNK)
