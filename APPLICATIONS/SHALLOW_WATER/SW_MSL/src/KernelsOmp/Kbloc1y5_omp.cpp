...
class Kbloc1y5_omp:virtual public Go
{
public:
  Datah* u2l;
  Datah* u2r;
...
#pragma omp parallel for shared(cu2l,cu2r,cv2l,cv2r,ch2g,ch2d,cg3) private(yy,xx,c,cd,qd,qg) schedule (static, CHUNK)
...
#include <KernelsOmp/Kbloc1y5_omp.l2c>
