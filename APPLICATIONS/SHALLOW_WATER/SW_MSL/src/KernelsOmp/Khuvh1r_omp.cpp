...
class Khuvh1r_omp:virtual public Go
{
public:
  Datah* h;
  Datah* u;
...
#pragma omp parallel for shared(ch,cu,cv,cz,ch1r) private(yy,xx,xx1,dh1,dh2,hl) firstprivate(yy1) schedule (static, CHUNK)
...
#include <KernelsOmp/Khuvh1r_omp.l2c>
