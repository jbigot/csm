...
class Kbloc1x5_omp:virtual public Go
{
public:
  Datah* u1l;
  Datah* u1r;
...
#pragma omp parallel for shared(cu1l,cu1r,cv1l,cv1r,ch1g,ch1d,cf3) private(yy,xx,c,cd,qd,qg) schedule (static, CHUNK)
...
#include <KernelsOmp/Kbloc1x5_omp.l2c>
