...
#pragma omp parallel for shared(ch,cu,cv,cz,ch1l,ch1r,cu1l,cu1r,cv1l,cv1r,cz1l,cz1r) private(yy,xx,xx1,dh1,dh2,du1,du2,dv1,dv2,dz1,dz2,hr,hl,ul,vl,zl,ur,vr,zr) firstprivate(yy1) schedule (static, CHUNK)
