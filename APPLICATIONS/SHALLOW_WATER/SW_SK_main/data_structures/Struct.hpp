...
public:
  ...
  /*! */
  //-------------------------------------------------------------------------------
  Structure (int64_t gW,int64_t gH):nb_proc(0),globH(gH),globW(gW)
  ,locH(0),locW(0),tile_x(0),tile_y(0),nb_tile_x(0),nb_tile_y(0),rank(0),remainderh(0),remainderw(0),ranks(0)
  {
