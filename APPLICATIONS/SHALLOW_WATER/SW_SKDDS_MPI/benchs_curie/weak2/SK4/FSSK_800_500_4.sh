#!/bin/bash
#MSUB -r weakSK_800_500_4         #job name
#MSUB -n 4                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_800_500_4_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_800_500_4_%I.e    #error file
#MSUB -q standard
