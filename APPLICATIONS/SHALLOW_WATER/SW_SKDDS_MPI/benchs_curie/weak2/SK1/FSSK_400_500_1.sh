#!/bin/bash
#MSUB -r weakSK_400_500_1         #job name
#MSUB -n 1                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_400_500_1_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_400_500_1_%I.e    #error file
#MSUB -q standard
