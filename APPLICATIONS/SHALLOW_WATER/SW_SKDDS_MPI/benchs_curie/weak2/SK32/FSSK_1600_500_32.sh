#!/bin/bash
#MSUB -r weakSK_1600_500_32         #job name
#MSUB -n 32                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_1600_500_32_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_1600_500_32_%I.e    #error file
#MSUB -q standard
