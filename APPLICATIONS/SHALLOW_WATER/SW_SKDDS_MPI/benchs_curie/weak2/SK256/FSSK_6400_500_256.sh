#!/bin/bash
#MSUB -r weakSK_6400_500_256         #job name
#MSUB -n 256                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_6400_500_256_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_6400_500_256_%I.e    #error file
#MSUB -q standard
