#!/bin/bash
#MSUB -r weakSK_3200_500_128         #job name
#MSUB -n 128                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_3200_500_128_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_3200_500_128_%I.e    #error file
#MSUB -q standard
