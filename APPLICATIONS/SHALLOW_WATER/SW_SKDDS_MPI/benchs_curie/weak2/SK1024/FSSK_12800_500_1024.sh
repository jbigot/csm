#!/bin/bash
#MSUB -r weakSK_12800_500_1024         #job name
#MSUB -n 1024                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_12800_500_1024_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_12800_500_1024_%I.e    #error file
#MSUB -q standard
