#!/bin/bash
#MSUB -r weakSK_400_500_2         #job name
#MSUB -n 2                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_400_500_2_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_400_500_2_%I.e    #error file
#MSUB -q standard
