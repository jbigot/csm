#!/bin/bash
#MSUB -r strongSK_10k_1k_16384         #job name
#MSUB -n 16384                     #number of nodes
#MSUB -T 100                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_16384_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_16384_%I.e    #error file
#MSUB -q standard
