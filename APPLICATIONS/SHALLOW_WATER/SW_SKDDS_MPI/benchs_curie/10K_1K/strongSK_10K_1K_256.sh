#!/bin/bash
#MSUB -r strongSK_10k_1k_256         #job name
#MSUB -n 256                     #number of nodes
#MSUB -T 800                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_256_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_256_%I.e    #error file
#MSUB -q standard
