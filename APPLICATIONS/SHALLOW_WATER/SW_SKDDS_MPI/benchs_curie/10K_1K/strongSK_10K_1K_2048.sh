#!/bin/bash
#MSUB -r strongSK_10k_1k_2048         #job name
#MSUB -n 2048                     #number of nodes
#MSUB -T 300                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_2048_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_2048_%I.e    #error file
#MSUB -q standard
