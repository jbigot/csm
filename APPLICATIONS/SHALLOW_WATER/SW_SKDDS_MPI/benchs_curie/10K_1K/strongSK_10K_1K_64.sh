#!/bin/bash
#MSUB -r strongSK_10k_1k_64         #job name
#MSUB -n 64                     #number of nodes
#MSUB -T 1500                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_64_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_64_%I.e    #error file
#MSUB -q standard
