#!/bin/bash
#MSUB -r strongSK_10k_1k_4096         #job name
#MSUB -n 4096                     #number of nodes
#MSUB -T 200                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_4096_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_4096_%I.e    #error file
#MSUB -q standard
