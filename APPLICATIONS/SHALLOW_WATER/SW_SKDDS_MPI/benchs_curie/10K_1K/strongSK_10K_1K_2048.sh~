#!/bin/bash
#MSUB -r strongSK_10k_1k_32         #job name
#MSUB -n 32                     #number of nodes
#MSUB -T 2000                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_32_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_32_%I.e    #error file
#MSUB -q standard
