#!/bin/bash
#MSUB -r strongSK_10k_1k_128         #job name
#MSUB -n 128                     #number of nodes
#MSUB -T 1000                  #time out
#MSUB -o $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_128_%I.o    #output file
#MSUB -e $WORKDIR/results/strong_scaling/10K_1K/SKMPI/strongSK_10k_1k_128_%I.e    #error file
#MSUB -q standard
