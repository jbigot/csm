#!/bin/bash
#MSUB -r weakSK_25600_500_16384         #job name
#MSUB -n 16384                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_25600_500_16384_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_25600_500_16384_%I.e    #error file
#MSUB -q standard
