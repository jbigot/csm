#!/bin/bash
#MSUB -r weakSK_51200_200_4096         #job name
#MSUB -n 4096                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/800/SKMPI/weakSK_51200_200_4096_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/800/SKMPI/weakSK_51200_200_4096_%I.e    #error file
#MSUB -q standard
