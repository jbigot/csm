#!/bin/bash
#MSUB -r weakSK_6400_500_512         #job name
#MSUB -n 512                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_6400_500_512_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/400/SKMPI/weakSK_6400_500_512_%I.e    #error file
#MSUB -q standard
