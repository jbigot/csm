#!/bin/bash
#MSUB -r weakSK_25600_200_2048         #job name
#MSUB -n 2048                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/800/SKMPI/weakSK_25600_200_2048_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/800/SKMPI/weakSK_25600_200_2048_%I.e    #error file
#MSUB -q standard
