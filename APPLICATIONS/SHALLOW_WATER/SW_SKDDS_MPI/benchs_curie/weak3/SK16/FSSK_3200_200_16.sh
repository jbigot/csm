#!/bin/bash
#MSUB -r weakSK_3200_200_16         #job name
#MSUB -n 16                     #number of nodes
#MSUB -T 500                  #time out
#MSUB -o $WORKDIR/results/weak_scaling/800/SKMPI/weakSK_3200_200_16_%I.o    #output file
#MSUB -e $WORKDIR/results/weak_scaling/800/SKMPI/weakSK_3200_200_16_%I.e    #error file
#MSUB -q standard
