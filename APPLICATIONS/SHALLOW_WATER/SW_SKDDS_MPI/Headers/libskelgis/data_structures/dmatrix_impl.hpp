  ...
  */
  ...
  protected:
      ...
      else
	{
      ...
      //std::cout<<Mpi_::mpi_rank<<" - cols="<<this->cols<<" rows="<<this->rows<<std::endl;
      //std::cout<<Mpi_::mpi_rank<<" - ("<<this->loc_head.width<<","<<this->loc_head.height<<")"<<std::endl;
      this->data = new T[this->border_head.width*this->border_head.height];
    }
    //-------------------------------------------------------------------------------
    //-------------------------------------------------------------------------------
  ...
  public:
    ...
    */
    ...
    //-------------------------------------------------------------------------------
    {
      ...
      getUpp = new char[this->loc_head.width*border*sizeof(T)];
      getRightt = new char[this->loc_head.height*border*sizeof(T)];
    }
    ...
    */
      ...
      if(this->row%2==0)
	{
	  if(this->row!=0)
	    {
	      getUpBorderToSend();
	      Communications<T>::Exchanges(toSendUp,toGetUp,getUpp,this->loc_head.width*border,mpi_ranks[1]);
	      setUpBorder(toGetUp);
	    }
	  if(this->row!=(this->rows-1))
	    {          
	      //rcv down
	      getDownBorderToSend();
	      Communications<T>::Exchanges(toSendUp,toGetUp,getUpp,this->loc_head.width*border,mpi_ranks[5]);
	  ...
	  if(this->col!=(this->cols-1))
	    {
	      ...
	      Communications<T>::Exchanges(toSendRight,toGetRight,getRightt,this->loc_head.height*border,mpi_ranks[3]);
	  ...
	  if(this->col!=0)
	    {
	      //rcv left
	      getLeftBorderToSend();
	      Communications<T>::Exchanges(toSendRight,toGetRight,getRightt,this->loc_head.height*border,mpi_ranks[7]);
