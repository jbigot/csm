+ SCRIPT_PID=103187
+ set +x
+ /bin/bash -x /tmp/jobstart.103173
++ id -u
+ '[' 24279 -ge 1000 ']'
...
[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(500050005000500050005000500050005000500050005000500050005000, , , , , , , , , , , , , , , 500050005000500050005000500050005000500050005000500050005000, , , , , , , , , , , , , , , 444444444444444)))))))))))))))
