#!/bin/bash
#MSUB -r heat_5k_5k_2048         #job name
#MSUB -n 2048                    #number of nodes
#MSUB -T 50                #time out
#MSUB -o outputs/heat_5k_5k_2048_%I.o    #output file
#MSUB -e outputs/heat_5k_5k_2048_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_5k_5k_2048.lad
