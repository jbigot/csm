#!/bin/bash
#MSUB -r heat_5k_5k_1         #job name
#MSUB -n 1                    #number of nodes
#MSUB -T 2000                 #time out
#MSUB -o outputs/heat_5k_5k_1_%I.o    #output file
#MSUB -e outputs/heat_5k_5k_1_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_5k_5k_1.lad
