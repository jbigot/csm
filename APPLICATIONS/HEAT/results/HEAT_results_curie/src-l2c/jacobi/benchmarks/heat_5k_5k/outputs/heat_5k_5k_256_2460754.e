+ SCRIPT_PID=107373
+ set +x
+ /bin/bash -x /tmp/jobstart.107359
++ id -u
+ '[' 24279 -ge 1000 ']'
...
++ export _LMSTICKY_
+ l2c_loader --mpi -c 256 lad/heat_5k_5k_256.lad
...
[MPIDriver] compute([MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute([MPIDriver] compute(50005000[MPIDriver] compute(500050005000500050005000500050005000[MPIDriver] compute(500050005000, , , , , , , , , , , , , 500050005000500050005000500050005000500050005000, 5000, 5000, , 5000, , , , , , , , , 5000, , 44, 444444444, 44))4)))))))))4))
