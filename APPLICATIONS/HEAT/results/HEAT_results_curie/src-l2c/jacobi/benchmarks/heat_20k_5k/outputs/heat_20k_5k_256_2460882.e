...
++ export _LMSTICKY_
+ l2c_loader --mpi -c 256 lad/heat_20k_5k_256.lad
...
[MPIDriver] compute(20000, 20000, 2)
[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(20000, 20000, 2)
[MPIDriver] compute(20000, 20000, 2)
20000[MPIDriver] compute([MPIDriver] compute(200002000020000200002000020000[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(20000, 20000, 2)
200002000020000, 20000, , , , , , 2000020000, , 20000[MPIDriver] compute(, 20000, 200002000020000200002000020000, , 2000020000, 2000020000, 20000, , , , , , 2000020000, , 20000, , 2, 222222, , 22, 200002)2))))))22))2, )
)
