+ SCRIPT_PID=117410
+ set +x
+ /bin/bash -x /tmp/jobstart.117396
++ id -u
+ '[' 24279 -ge 1000 ']'
...
[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(50005000[MPIDriver] compute(5000[MPIDriver] compute(50005000[MPIDriver] compute(5000500050005000500050005000, , 5000, 5000, , 5000, , , , , , , 50005000, 5000, 50005000, 5000500050005000500050005000, , 5000, 5000, , 5000, , , , , , , 44, 4, 44, 4444444))4)4))4)))))))
