+ SCRIPT_PID=109448
+ set +x
+ /bin/bash -x /tmp/jobstart.109434
++ id -u
+ '[' 24279 -ge 1000 ']'
...
++ export _LMSTICKY_
+ l2c_loader --mpi -c 256 lad/heat_5k_500_256.lad
...
[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute([MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute(5000[MPIDriver] compute(500050005000500050005000500050005000[MPIDriver] compute(5000[MPIDriver] compute(5000, 5000, , , , , , , , , 5000, 5000, 5000, 500050005000500050005000500050005000, 5000, 5000, 5000, , , , , , , , , 5000, 5000, 444444, 4, 44, 444)))))4))4)4))))
)
