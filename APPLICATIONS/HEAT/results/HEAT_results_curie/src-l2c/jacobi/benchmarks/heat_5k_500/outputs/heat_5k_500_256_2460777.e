+ SCRIPT_PID=111523
+ set +x
+ /bin/bash -x /tmp/jobstart.111509
++ id -u
+ '[' 24279 -ge 1000 ']'
...
[MPIDriver] compute([MPIDriver] compute([MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute(5000500050005000500050005000, 5000, 4)
5000500050005000, 5000, 4)
5000, 5000, 4)
5000[MPIDriver] compute(5000, , , , , , 5000, , , [MPIDriver] compute(5000, 5000, 4)
[MPIDriver] compute(, 50005000, 500050005000500050005000, , 500050005000500050005000, , , , , , 5000, , , , , , 5000, 444444, 444500050004, 4))))))4))), , )4)
