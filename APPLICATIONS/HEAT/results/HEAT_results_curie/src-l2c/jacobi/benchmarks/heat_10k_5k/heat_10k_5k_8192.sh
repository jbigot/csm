#!/bin/bash
#MSUB -r heat_10k_5k_8192         #job name
#MSUB -n 8192                    #number of nodes
#MSUB -T 50                #time out
#MSUB -o outputs/heat_10k_5k_8192_%I.o    #output file
#MSUB -e outputs/heat_10k_5k_8192_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_10k_5k_8192.lad
