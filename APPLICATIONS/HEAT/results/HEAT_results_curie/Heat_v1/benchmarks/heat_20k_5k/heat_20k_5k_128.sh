#!/bin/bash
#MSUB -r heat_20k_5k_128         #job name
#MSUB -n 128                    #number of nodes
#MSUB -T 1000                #time out
#MSUB -o outputs/heat_20k_5k_128_%I.o    #output file
#MSUB -e outputs/heat_20k_5k_128_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_20k_5k_128.lad
