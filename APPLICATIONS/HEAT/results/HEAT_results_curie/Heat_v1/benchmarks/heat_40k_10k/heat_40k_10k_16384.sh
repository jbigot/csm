#!/bin/bash
#MSUB -r heat_40k_10k_16384         #job name
#MSUB -n 16384                    #number of nodes
#MSUB -T 300                #time out
#MSUB -o outputs/heat_40k_10k_16384_%I.o    #output file
#MSUB -e outputs/heat_40k_10k_16384_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_40k_10k_16384.lad
