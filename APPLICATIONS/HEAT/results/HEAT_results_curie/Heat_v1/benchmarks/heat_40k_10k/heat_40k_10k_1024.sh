#!/bin/bash
#MSUB -r heat_40k_10k_1024         #job name
#MSUB -n 1024                    #number of nodes
#MSUB -T 2000                #time out
#MSUB -o outputs/heat_40k_10k_1024_%I.o    #output file
#MSUB -e outputs/heat_40k_10k_1024_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_40k_10k_1024.lad
