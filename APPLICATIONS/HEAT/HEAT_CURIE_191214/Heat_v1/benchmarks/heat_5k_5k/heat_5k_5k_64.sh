#!/bin/bash
#MSUB -r heat_5k_5k_64         #job name
#MSUB -n 64                    #number of nodes
#MSUB -T 150                #time out
#MSUB -o outputs/heat_5k_5k_64_%I.o    #output file
#MSUB -e outputs/heat_5k_5k_64_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_5k_5k_64.lad
