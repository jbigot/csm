#!/bin/bash
#MSUB -r heat_5k_500_128         #job name
#MSUB -n 128                     #number of nodes
#MSUB -T 15                  #time out
#MSUB -o outputs/heat_5k_500_128_%I.o    #output file
#MSUB -e outputs/heat_5k_500_128_%I.e    #error file
#MSUB -q standard
...
l2c_loader --mpi -c ${BRIDGE_MSUB_NPROC} lad/heat_5k_500_128.lad
