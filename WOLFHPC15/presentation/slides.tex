...
\def \margin {8} % margin in angles, depends on the radius
  ...
  \path[line] (plus) -- node [fill=white,align=center] {\scriptsize Numerical mathods\\\scriptsize Finite difference/volume/elment} (sche);
\end{tikzpicture}
}
\end{center}
\end{frame}
...
%----------------
\begin{frame}
\frametitle{Back to Data Parallelism}
\begin{center}
\textbf{Back to Data Parallelism only ?}\\
\end{center}
\textbf{Loop Fusion}: Same computation domain under a sequence or a parallel node
...
\resizebox{\textwidth}{!}{\includegraphics{./images/logtimes_10K_500.pdf}}
\end{center}
\end{column}
\begin{column}{.5\textwidth}
\begin{center}
\small Mesh $10k \times 10k$, $2K$ iterations\\
\resizebox{\textwidth}{!}{\includegraphics{./images/logtimes_10K_2K.pdf}}
\end{center}
\end{column}
\end{columns}
\end{frame}
