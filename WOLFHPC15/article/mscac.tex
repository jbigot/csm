...
\begin{tikzpicture}[remember picture,
  ...
  \draw[->] (Dump.east) -- (CA);
\end{tikzpicture}
\caption{The three phases of the MSCAC compiler. First the parser of the MSL description, second the MSC parallelization, third the dump to the Component-Based Runtime (CBR).}
\label{fig:mscac}
\end{center}
\end{figure}
