...
The last part of the assembly is the computation part.
Each computation kernel is embedded in a different kernel component which has to be written by the user and provided
to the compiler.
We denote this kind of components K.
A kernel component encapsulates a computations. To
