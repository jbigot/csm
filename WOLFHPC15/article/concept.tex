...
\end{center}
\caption{(a) a Cartesian mesh and two kind of mesh entities, (b) an example of stencil kernel on cells, (c) an example of stencil kernel on different entities of the mesh.}
\label{fig:gspmsp}
\end{figure}
