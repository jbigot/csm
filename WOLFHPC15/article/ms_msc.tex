...
\todo[inline]{JB: "is applied on the computation domain of $c_1$" vraiment, c'est pas ce que tu dis juste avant ...}
...
\todo[inline]{JB: dans le DAG il y a une dependance de c2 a sync4, le graphe serie parallele les execute en parallele ...}
