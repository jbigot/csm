...
bc_liquid_left::bc_liquid_left(): boundary_condition() {
    unormbound = 0.;
    utanbound = 0.;
    hbound = 0.;
}
...
void bc_liquid_left::calcul(SCALAR hin, SCALAR unorm_in, SCALAR utan_in, SCALAR hfix, SCALAR qfix) {
