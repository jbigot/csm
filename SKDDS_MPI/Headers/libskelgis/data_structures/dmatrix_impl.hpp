...
namespace skelgis{
  ...
  */
  //-------------------------------------------------------------------------------
  template<class T,int R,bool line=false> struct DMatrix_impl : public DMatrix_base<T>
  //-------------------------------------------------------------------------------
  {
  protected:
    ...
    */
    ...
    //-------------------------------------------------------------------------------
    {
      if(this->row%2==0)
      {
        ...
        {
          getUpBorderToSend();
          Communications<T>::Exchanges(toSendUp,toGetUp,getUp,this->loc_head.width*border,mpi_ranks[1]);
          setUpBorder(toGetUp);
        }
        if(this->row!=(this->rows-1))
        {    
          getDownBorderToSend();
          Communications<T>::Exchanges(toSendUp,toGetUp,getUp,this->loc_head.width*border,mpi_ranks[5]);
      ...
      { 
        ...
        {   
          ...
          Communications<T>::Exchanges(toSendRight,toGetRight,getRight,this->loc_head.height*border,mpi_ranks[3]);
        ...
        if(this->col!=0)
        {
          ...
          getLeftBorderToSend();
          Communications<T>::Exchanges(toSendRight,toGetRight,getRight,this->loc_head.height*border,mpi_ranks[7]);
