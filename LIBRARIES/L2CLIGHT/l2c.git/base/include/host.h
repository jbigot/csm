...
#ifndef LLCMCPP_HOST_H
#define LLCMCPP_HOST_H
...
/*! \brief a Host manages a set of component instances in one process.
 */
class Host
{
public:
	/*! \brief a opaque handle identifying component instances handled by this host
	 */
	typedef uint16_t ComponentInstance;
