...
\HC{how to choose data or hybrid, change on the fly if needed}
\HC{how to choose if a fusion is good or not, change on the fly or learning strategies onto production codes}
\HC{In addition to this, by using components, doors to online reconfiguration of applications~\cite{Lanore:2015:RCM:2737166.2737169} are also open (even if not answered in this paper).}
