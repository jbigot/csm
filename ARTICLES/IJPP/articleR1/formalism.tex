...
\item $(w,D) \in \mathbb{V} \times \mathcal{D}$ is the single data written by the kernel:\JB{$\mathbb{V}$ contient les scalaires pour lesquels la notion de domaine de calcul n'est pas definie}
\begin{itemize}
...
% Moreover, one can note that the usual \emph{scatter} optimization of numerical codes is actually a specific case of fusion.
