...
\HC{add a figure of the final specialized assembly with the scheduler and sync components}
...
Although the version 4 of OpenMP has introduced explicit support for tasks, our implementation only requires version 3 whose fork-join model is well suited for the static scheduling introduced in Section~\ref{sect:msp}.
