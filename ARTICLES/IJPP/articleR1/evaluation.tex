...
%\CP{les rappeler !}
%
them, the two first ones (Figures~\ref{fig:fus1} and~\ref{fig:fus2}~\vpageref{fig:fus2}) have been automatically detected by MSF in this case study.% (the third scatter optimization of Fig.~\ref{fig:fus3} has not been detected).
%\CP{Et la troisieme ?}
