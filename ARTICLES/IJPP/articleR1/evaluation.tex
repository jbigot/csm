...
%\CP{les rappeler !}
%
have been formally detailed in Section~\ref{sect:fusion}. The two first ones of Figures~\ref{fig:fus1} and~\ref{fig:fus2}~\vpageref{fig:fus2} have been automatically detected by MSF in our case study (\ie the third scatter optimization of Fig.~\ref{fig:fus3} has not been detected).
%\CP{Et la troisieme ?}
