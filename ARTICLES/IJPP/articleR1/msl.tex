...
\begin{tikzpicture}[shorten >=1pt, node distance=2cm, on grid, auto]
   ...
   \node[component, draw=green!80!black,right=2cm of Cp] (C) {$Computations$};
   ...
   \node[component,double, draw=red,above=0.8cm of Datap2] (Data) {$Data$};
   ...
   \node[component, draw=red,above=0.8cm of DDSp2] (DDS) {$DDS$};
