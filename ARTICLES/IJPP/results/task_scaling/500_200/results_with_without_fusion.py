...
#plt.loglog(cores, itsT2, 'c-*', label='2 cores for tasks without fusion', basex=2,basey=2)
plt.loglog(cores, itsT8, 'm-*', label='8 cores for tasks without fusion', basex=2,basey=2)
#plt.loglog(cores, itsT2fus, 'c-+', label='2 cores for tasks with fusion', basex=2,basey=2)
plt.loglog(cores, itsT8fus, 'm-+', label='8 cores for tasks with fusions', basex=2,basey=2)
