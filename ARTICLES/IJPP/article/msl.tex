...
\item Finally, the last part (Fig.\ref{fig:grammar},~l.8) introduce the computations loops. Each loop is made of two parts:
\begin{itemize}
...
\item the \texttt{computations} keyword (Fig.\ref{fig:grammar},~l.23) introduces identifiers for the computation $k\in\Gamma=(S,R,(w,D),comp)$.
\end{itemize}

\item each computation (Fig.\ref{fig:grammar},~l.26) specifies:
\begin{itemize}
