...
\end{mydef}
 ...
 %$c^*_j(R_j,w_j,\text{exp}_j,*_j)$ if $\bigcup_{i} \{w_i\} \neq \emptyset \text{, }\forall i<j\text{, and }c_i \pprec c_j$. In such a case $*_j$ is itself a computation wich performs $update(\bigcup_{i} \{w_i\})$.
